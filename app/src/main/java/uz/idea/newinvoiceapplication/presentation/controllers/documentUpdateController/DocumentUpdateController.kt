...
import uz.idea.domain.models.createActModel.Actdoc
import uz.idea.domain.models.createActModel.Contractdoc
import uz.idea.domain.models.createActModel.CreateActModel
import uz.idea.domain.models.createActModel.Productlist
...
import uz.idea.newinvoiceapplication.databinding.FragmentUpdateBinding
import uz.idea.newinvoiceapplication.presentation.activities.MainActivity
import uz.idea.newinvoiceapplication.presentation.screens.updateDocument.UpdateFragment
...
import uz.idea.newinvoiceapplication.utils.appConstant.AppConstant.ERROR_BRANCH_CODE
    ...
    private fun updateActData(actDocument: ActDocument?){
        binding.apply {
            ...
            if (actDoc!=null && contractDoc!=null && companyInfoMain!=null){
                ...
                liveList.observe(updateFragment.viewLifecycleOwner){ listProduct->
                    val listProducts = LinkedList<uz.idea.domain.models.createActModel.Product>()
                    listProduct.onEach { actProductEntity->
                        listProducts.add(
                            uz.idea.domain.models.createActModel.Product(

package uz.einvoice.android.utils.container
...
import uz.einvoice.android.databinding.LoadingApplicationBinding
import uz.einvoice.android.presentation.activities.MainActivity
import uz.einvoice.android.utils.dialogHelper.DialogHelper
import uz.einvoice.android.utils.screenNavigate.ScreenNavigate
...
class ContainerApplication(
    ...
    fun dialogStatus(
        ...
        dialogHelper.statusDialog(status,message,onClick)
    }
